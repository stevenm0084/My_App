...
public class EndOfRoundActivity extends ActionBarActivity {
...
/*         playerImage = (ImageView) findViewById(R.id.player_image);
        ...
        nextRound = (ImageButton) findViewById(R.id.next_round);*/
    }

    @Override
    public boolean onCreateOptionsMenu(Menu menu) {
        // Inflate the menu; this adds items to the action bar if it is present.
        getMenuInflater().inflate(R.menu.menu_end_of_round, menu);
        return true;
    }
